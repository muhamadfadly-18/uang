...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('target.create') }}" class="btn btn-primary shadow-sm px-3">+ Tambah Target</a>
    </div>
        ...
        @forelse($targets as $index => $t)
            ...
            <div class="col-12 col-md-6 mb-4 fade-in" style="animation-delay: {{ $index * 0.1 }}s;">
                ...
                <div class="card-action text-center">
                    <div class="d-flex justify-content-center gap-2 flex-wrap">
                        <a href="{{ route('target.edit', $t->id) }}" class="btn btn-warning btn-sm px-3">
                            ✏️ Edit
                        </a>

                        <form action="{{ route('target.destroy', $t->id) }}" method="POST" class="formHapus d-inline">
                            @csrf
                            @method('DELETE')
            ...
            <div class="modal fade" id="addTercapaiModal{{ $t->id }}" tabindex="-1">
                <div class="modal-dialog">
                    <form action="{{ route('target.tercapai', $t->id) }}" method="POST" class="modal-content formTercapai">
                        @csrf
