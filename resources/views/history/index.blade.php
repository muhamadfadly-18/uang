                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @if(strtolower($d->jenis) == 'pemasukan')
                                        <span class="text-success fw-semibold">+ Rp {{ number_format($d->jumlah, 0, ',', '.') }}</span>
                                        @php $saldo += $d->jumlah; @endphp
                                    @else
                                        <span class="text-danger fw-semibold">- Rp {{ number_format($d->jumlah, 0, ',', '.') }}</span>
                                        @php $saldo -= $d->jumlah; @endphp
                                    @endif
                                </td>
                        ...
                        <tfoot class="table-light">
                            <tr>
                                <th colspan="3" class="text-end">Saldo Hari Ini</th>
